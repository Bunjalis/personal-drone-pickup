...
class QuadDynamics:
    def __init__(self):
        ...
        self.p_param = cs.vertcat(self.thrust_ratio, self.tau_rate, self.tau_throttle, self.centre_rate_deg, self.max_rate_deg, self.rate_expo)  # Parameter vector
    ...
    def u_dynamics(self):
        # Direct response for all control channels
        return self.u_dot