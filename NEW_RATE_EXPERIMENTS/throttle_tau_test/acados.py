...
def generate_ocp_controller(dynamics=None):
    ...
    ocp.parameter_values = np.array([38.0, 0.07,0.07, 80.0,250.0,0.5])  # Default parameters: thrust ratio, second parameter, and third parameter
    ...
    ocp.constraints.lbu = np.array([-10.0, -10.0, -3.0, -10.0])  # throttle, roll_rate, pitch_rate, yaw_rate
    ocp.constraints.ubu = np.array([10.0, 10.0, 3.0, 10.0])
    ...
    sim.parameter_values = np.array([38.0, 0.07, 0.07, 80.0,250.0,0.5])
