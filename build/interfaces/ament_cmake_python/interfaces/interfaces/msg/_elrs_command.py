...
class ELRSCommand(metaclass=Metaclass_ELRSCommand):
    ...
    def __init__(self, **kwargs):
        ...
        self.channel_11 = kwargs.get('channel_11', float())
    ...
    def __eq__(self, other):
        ...
        if self.channel_10 != other.channel_10:
            return False
        if self.channel_11 != other.channel_11:
            return False
        return True
    ...
    @builtins.property
    def channel_11(self):
        """Message field 'channel_11'."""
        return self._channel_11
    ...
    def channel_11(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'channel_11' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'channel_11' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._channel_11 = value
