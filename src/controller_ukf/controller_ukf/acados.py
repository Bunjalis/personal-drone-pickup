...
def generate_ocp_controller(dynamics=None):
    ...
    # Input bounds
    ocp.constraints.lbu = np.array([-5.0, -5.0, -0.5, -5.0])  # [throttle_dot, roll_rate_dot, pitch_rate_dot, yaw_rate_dot]
    ocp.constraints.ubu = np.array([ 5.0,  5.0,  0.5,  5.0])
