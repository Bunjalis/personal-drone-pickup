...
class Controller(Node):
    ...
    def control_loop(self):
        ...
        if self.armed and self.pre_start_counter < self.pre_start_steps:
            ...
            kpx, kix, kdx = 6.0*0.1, 0,  0.0 #.012.0*0.005#0.6, 0, 1.2#0.5, 0,0.4
            kpy, kiy, kdy = 6.0*0.1, 0, 0.0 #12.0*0.005#0.6, 0, 1.2#0.36, 0, 0.45

            kpp, kip, kdp = 60.0, 10.0, 30.0 #6.0, 1.5, 1.75 #5.0, 3.0, 3.0 # 2.4, 0.48, 3.09 #
            kpr, kir, kdr = 60.0, 10.0, 30.0#6.0, 1.5, 1.75 # 2.1, 0.84, 1.3125 #
            kpyaw, kiyaw, kdyaw = 60.0, 10.0, 30#6.0, 1.5, 1.75 # #0.804, 0.29236, 0.55275
            ...
            rd = (Ux*sin(yawd) - Uy*cos(yawd))*self.M/force
            pd = (Ux*cos(yawd) + Uy*sin(yawd))*self.M/force
