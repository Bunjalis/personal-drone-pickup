...
class QuadDynamics:
    def __init__(self):
        ...
        self.p_param = cs.vertcat(self.thrust_ratio,
                                  ...
                                  self.max_rate_deg ,
                                  self.rate_expo)  # Parameter vector
    ...
    def v_dynamics(self):
        ...
        drag_force = cs.vertcat(
            -self.drag_coeff_z * (self.v[0] - wind_across),   # Vertical drag proportional to X velocity
            -self.drag_coeff_z * (self.v[1] - wind_along),    # Vertical drag proportional to Y velocity
            -self.drag_coeff_z * (self.v[2] - wind_vertical)  # Vertical drag proportional to Z velocity
        )
